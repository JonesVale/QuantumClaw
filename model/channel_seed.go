...
var defaultChannelModels = map[int]string{
	channeltype.OpenAI:        "gpt-4o,gpt-4o-mini,gpt-4-turbo,gpt-4,gpt-3.5-turbo",
	channeltype.Anthropic:     "claude-3-5-sonnet-20241022,claude-3-opus,claude-3-sonnet,claude-3-haiku",
	channeltype.Gemini:        "gemini-1.5-pro,gemini-1.5-flash,gemini-1.0-pro",
	channeltype.DeepSeek:      "deepseek-chat,deepseek-reasoner,deepseek-coder",
	...
	channeltype.Ali:           "qwen-turbo,qwen-plus,qwen-max",
	...
	channeltype.OpenRouter:    "openrouter/auto",
...
func SeedDefaultChannels() {
	...
	aiChannels := []int{
		...
		channeltype.Mistral, channeltype.OpenRouter, channeltype.Doubao,
