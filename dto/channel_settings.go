...
// ChannelSettings holds per-channel configuration that can be set via admin UI.
...
// VertexKeyType specifies how Vertex AI keys are provided.
...
// AwsKeyType specifies how AWS credentials are provided.
...
// ChannelOtherSettings holds additional channel-level settings.
