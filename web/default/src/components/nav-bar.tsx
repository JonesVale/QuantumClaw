      ...
      <div className="qc-wrap">
        <div className="flex items-center justify-between h-[4.5rem]">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            {/* Notification Bell */}
            {loggedIn && (
              <Link to="/notifications" className="relative w-10 h-10 rounded-xl hover:bg-muted/50 flex items-center justify-center transition-colors text-muted-foreground">
            ...
            {loggedIn ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <Link to="/sign-in" className="relative px-5 py-2.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-amber-500 to-orange-500 shadow-md shadow-orange-500/20 hover:shadow-lg hover:-translate-y-0.5 transition-all duration-200">
                  {t('Get Started')}
                </Link>
              </div>
            )}
