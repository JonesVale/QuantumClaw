...
import {
  ...
  requestStripeTopUp, requestEpayTopUp, requestCreemTopUp, requestWaffoTopUp, requestBinanceTopUp, requestAlipayTopUp, requestWorldFirstTopUp,
...
function WalletPage() {
  ...
  const paymentMethods: string[] = (() => {
    ...
    if (info.enable_worldfirst_topup) methods.push('worldfirst')
    return methods
  })()
  ...
  const handleTopup = async (method: string) => {
    ...
    try {
      const apiMap: Record<string, (amt: number) => Promise<any>> = {
        ...
        worldfirst: requestWorldFirstTopUp,
      }
